      ...
      <div className="relative">
        ...
        <div className="relative bg-white/80 dark:bg-gray-900/80 backdrop-blur-xl rounded-3xl shadow-2xl border border-white/40 dark:border-gray-700/40 overflow-hidden">
          ...
          <div className="lg:grid lg:grid-cols-5 lg:gap-0">
              ...
              <div className="relative h-64 sm:h-80 lg:h-[600px] xl:h-[700px] overflow-hidden">
                ...
                <div className="absolute inset-0 flex flex-col justify-end p-4 sm:p-6 lg:p-10">
                  ...
                  <div className="flex flex-wrap items-center gap-2 sm:gap-3 mb-3 sm:mb-4">
                    <div className="inline-flex items-center gap-2 bg-white/20 backdrop-blur-sm rounded-full px-3 sm:px-4 py-1 sm:py-2 border border-white/30">
                      <div className="w-2 h-2 bg-emerald-400 rounded-full animate-pulse"></div>
                      <span className="text-white text-xs sm:text-sm font-semibold tracking-wide">
                        Chef's Special
                      </span>
                    </div>
                    <div className="inline-flex items-center gap-2 bg-gradient-to-r from-orange-500/20 to-red-500/20 backdrop-blur-sm rounded-full px-3 sm:px-4 py-1 sm:py-2 border border-orange-200/30">
                  ...
                  {/* Recipe Title */}
                  <h1 className="text-xl sm:text-2xl md:text-3xl lg:text-4xl xl:text-5xl font-bold text-white mb-3 sm:mb-4 lg:mb-6 leading-tight">
                    {recipe.name}
                  </h1>

                  {/* Recipe Stats - Improved Mobile Layout */}
                    ...
                    <div className="bg-white/10 backdrop-blur-md rounded-xl lg:rounded-2xl p-2 sm:p-3 lg:p-4 border border-white/20">
                      <div className="text-center">
                        ...
                        <div className="text-white text-xs sm:text-sm font-semibold">
                          {recipeStats.cookingTime} min
                        </div>
                        <div className="text-white/70 text-xs hidden sm:block">Cook Time</div>
                      </div>
                    </div>
                    <div className="bg-white/10 backdrop-blur-md rounded-xl lg:rounded-2xl p-2 sm:p-3 lg:p-4 border border-white/20">
                      <div className="text-center">
                        ...
                        <div className="text-white text-xs sm:text-sm font-semibold">
                          {recipeStats.servings} people
                        </div>
                        <div className="text-white/70 text-xs hidden sm:block">Servings</div>
                      </div>
                    </div>
                    <div className="bg-white/10 backdrop-blur-md rounded-xl lg:rounded-2xl p-2 sm:p-3 lg:p-4 border border-white/20">
                      <div className="text-center">
                        <div className="text-lg sm:text-xl lg:text-2xl mb-1">⭐</div>
                        <div className="text-white text-xs sm:text-sm font-semibold">
                          {recipeStats.rating.toFixed(1)}
                        </div>
                        <div className="text-white/70 text-xs hidden sm:block">Rating</div>
                      </div>
                    </div>
                  </div>
            ...
            <div className="lg:col-span-2 p-4 sm:p-6 lg:p-10 bg-gradient-to-br from-gray-50/50 to-gray-100/50 dark:from-gray-800/50 dark:to-gray-900/50">
              ...
              <div className="flex flex-col xl:grid xl:grid-cols-2 xl:gap-6">
                ...
                <div className="mb-6 xl:mb-0">
                  ...
                  <div className="flex items-center justify-between mb-4 lg:mb-6">
                    <div className="flex items-center gap-2 lg:gap-3">
                      ...
                      <div>
                        <h3 className="text-lg lg:text-xl xl:text-2xl font-bold text-gray-900 dark:text-gray-100">
                          Shopping List
                        </h3>
                  ...
                  {/* Ingredients List */}
                  <div className="space-y-2 lg:space-y-3 max-h-64 xl:max-h-80 overflow-y-auto pr-2 scrollbar-thin scrollbar-thumb-gray-300 dark:scrollbar-thumb-gray-600">
                    {recipe.ingredients.map((ingredient, index) => (
                      <label
                        key={index}
                        className="group flex items-center gap-3 lg:gap-4 p-3 lg:p-4 rounded-lg lg:rounded-xl hover:bg-white/80 dark:hover:bg-gray-700/50 transition-all duration-200 cursor-pointer border border-gray-200/50 dark:border-gray-700/50 hover:border-gray-300 dark:hover:border-gray-600 hover:shadow-md"
                      >
                        <div className="relative">
                          <input
                            type="checkbox"
                            ...
                            className="w-5 h-5 lg:w-6 lg:h-6 text-emerald-600 rounded-lg focus:ring-emerald-500 focus:ring-2 border-2 border-gray-300 dark:border-gray-600"
                          />
                        ...
                        <span
                          className={`flex-1 text-sm lg:text-base transition-all duration-300 ${
                            checkedIngredients[index]
                ...
                <div>
                  <button
                    ...
                    className="group flex items-center justify-between w-full mb-4 lg:mb-6 hover:bg-white/50 dark:hover:bg-gray-700/30 rounded-lg lg:rounded-xl p-3 lg:p-4 transition-all duration-200"
                  >
                    <div className="flex items-center gap-2 lg:gap-3">
                      <div className="w-10 h-10 lg:w-12 lg:h-12 bg-gradient-to-br from-orange-500 to-red-600 rounded-xl lg:rounded-2xl flex items-center justify-center shadow-lg">
                        <span className="text-white text-lg lg:text-xl">👨‍🍳</span>
                      </div>
                    ...
                    <div
                      className={`w-8 h-8 lg:w-10 lg:h-10 bg-gray-100 dark:bg-gray-700 rounded-full flex items-center justify-center transform transition-all duration-300 group-hover:bg-gray-200 dark:group-hover:bg-gray-600 ${
                        showSteps ? "rotate-180" : ""
                      }`}
                    >
                      <svg
                        className="w-4 h-4 lg:w-5 lg:h-5 text-gray-600 dark:text-gray-300"
                        fill="none"
                        stroke="currentColor"
                        viewBox="0 0 24 24"
                      >
                  ...
                  {showSteps && (
                    <div className="space-y-4 lg:space-y-6 animate-slide-in-from-top-2 max-h-64 xl:max-h-80 overflow-y-auto pr-2 scrollbar-thin scrollbar-thumb-gray-300 dark:scrollbar-thumb-gray-600">
                      {recipe.steps.map((step, index) => (
                        <div key={index} className="flex gap-3 lg:gap-4 group">
                          <div className="flex-shrink-0">
                            <div className="w-8 h-8 lg:w-10 lg:h-10 bg-gradient-to-br from-orange-500 to-red-600 text-white rounded-lg lg:rounded-xl flex items-center justify-center font-bold shadow-lg text-sm lg:text-base">
                              {index + 1}
                            </div>
                          </div>
