...
const moods = [
  { emoji: "😴", text: "Lazy", value: "lazy", color: "from-indigo-500 to-blue-600" },
  { emoji: "❤️", text: "Romantic", value: "romantic", color: "from-pink-500 to-red-500" },
  { emoji: "😌", text: "Stressed", value: "stressed", color: "from-emerald-500 to-teal-500" },
  { emoji: "🤩", text: "Excited", value: "excited", color: "from-amber-500 to-orange-500" },
  { emoji: "🥳", text: "Party", value: "party", color: "from-purple-500 to-violet-600" }
];

export default function QuickMoodSelector({ currentMood, onSelectMood, className = "" }: QuickMoodSelectorProps) {
  return (
