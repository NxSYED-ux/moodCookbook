...
export default function Home() {
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50/30 to-indigo-50/50 relative overflow-hidden">
        ...
        <div className="absolute inset-0 opacity-30">
          <div className="absolute top-0 left-0 w-full h-full bg-[radial-gradient(circle_at_20%_50%,rgba(120,119,198,0.1),transparent_70%)]"></div>
          <div className="absolute top-0 right-0 w-full h-full bg-[radial-gradient(circle_at_80%_20%,rgba(255,154,0,0.1),transparent_70%)]"></div>
          <div className="absolute bottom-0 left-0 w-full h-full bg-[radial-gradient(circle_at_40%_90%,rgba(34,197,94,0.1),transparent_70%)]"></div>
        </div>
  ...
  if (state === "loading") {
    return (
      <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50/30 to-indigo-50/50 relative overflow-hidden py-12">
        {/* Animated background */}
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-6">
          ...
          <div className="text-center mt-8">
            <button
              ...
              className="inline-flex items-center gap-2 text-gray-600 hover:text-gray-800 bg-white/80 backdrop-blur-sm px-4 py-2 rounded-full transition-all duration-200 hover:bg-white shadow-lg"
            >
      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50/30 to-indigo-50/50 relative overflow-hidden py-12">
        ...
        <div className="relative z-10 max-w-6xl mx-auto px-6">
          <div className="text-center mb-10">
            <button
              onClick={handleBackToMoods}
              className="inline-flex items-center gap-2 text-gray-600 hover:text-gray-800 bg-white/80 backdrop-blur-sm px-6 py-3 rounded-full transition-all duration-200 hover:bg-white shadow-lg mb-6"
            >
